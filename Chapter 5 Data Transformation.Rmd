...
We expect to see `air_time` equals `arr_time - dep_time`, however they are not remotely equal, and they shouldn't be, because as mentioned in problem 1, `dep_time` and `arr_time` (and their corresponding scheduked version) are not recorded in a continous manner but hour and minutes. So a version of more convenient representation of number of minutes since midnight should be created.
