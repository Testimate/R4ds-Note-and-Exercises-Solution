...
Notes and code corresponds to Hadley Wickham's 'R for Data Science' material, starting from Chapter 5. <http://r4ds.had.co.nz/transform.html#introduction-2>
...
#### Testimate: first and last - filter(r %in% range(r))
...
Counts: To count the number of non-missing values, use `sum(!is.na(x))`. To count the number of distinct (unique) values, use `n_distinct(x)`.
