...
*Question: Calculate the average positive delay (by day).*
```{r}
...
*Question: Find the first and last flight of each day.*
...
*Question: Which destinations `(group_by(dest))` have the most carriers?*
