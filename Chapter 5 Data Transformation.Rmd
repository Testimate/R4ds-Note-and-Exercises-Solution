...
Idea: create a variable `timeOnAir` to measure the flight time (`arr_time - dep_time`, while `air_time` is the time when plane is literally on air), and create a new dataset `flights_Testimate` that contains `timeOnAir`.
...
You select the variable once despite multiple select call.
